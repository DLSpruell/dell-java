...
public class PigLatin {
	...
	public static void change(String newWord2) {
		...
		if (newWord2.startsWith("a") || newWord2.startsWith("e") || newWord2.startsWith("i") || newWord2.startsWith("o")
				|| newWord2.startsWith("u")) { // if the word starts with a vowel, print out the following
			System.out.println("The translation in Pig Latin is " + newWord2 + "yay!");
		} else if (newWord2.contains("a") || newWord2.contains("e") || newWord2.contains("i") || newWord2.contains("o")
				|| newWord2.contains("u")) // if the word contains a vowel, print out the following
		{
			newWord2 = newWord2.substring(1);
			newWord2 += first + "ay";
			System.out.println("The translation in Pig Latin is " + newWord2 + ".");
		} else {
			System.out.println("The translation in Pig Latin is " + newWord2 + "ay.");
		} // if the word doesn't start with or contain a vowel, print out the following
